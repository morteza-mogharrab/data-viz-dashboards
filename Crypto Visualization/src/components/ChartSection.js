                ...
                Price: {
                    options: {
                        ...
                        grid: {
                            ...
                            style: {
                                fontSize: '14px', fontWeight: 'bold', color: "#00796B"
                            }
                        }, stroke: {
                            curve: 'straight',
                            width: 1 
                ...
                ,Market_Cap: {
                    options: {
                        grid: {
                            ...
                            text: "Market Cap (USD)",
                            style: {
                                fontSize: '14px', fontWeight: 'bold', color: '#26A69A'
                            }
                        }, stroke: {
                            curve: 'straight',
                            width: 1 
                ...
                Tot_Vol: {
                    options: {
                        grid: {
                            ...
                            text: "Market Volume",
                            style: {
                                fontSize: '14px', fontWeight: 'bold', color: "#009688"
                            }
                        }, stroke: {
                            curve: 'straight',
                            width: 1 
                    ...
                    <div className="row">
                        ...
                        <div className="col" style={{ maxWidth: '200px' }}>
                            <div className="card-body">
                                <h6 className="card-title" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#0D6EFD' }}> Market Cap </h6>
                                <p className="card-text fw-bold" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#212529', fontSize: 'small' }}>
                                    $ {this.props.MarketCap}
                                </p>
                            </div>

                            <div className="card-body">
                                <h6 className="card-title" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#198754' }}> Price Change 24hrs </h6>
                                <p className="card-text fw-bold" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#212529', fontSize: 'small' }}>
                            ...
                            <div className="card-body">
                                <h6 className="card-title" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#FFC107' }}> Total Volume </h6>
                                <p className="card-text fw-bold" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#212529', fontSize: 'small' }}>
                                    $ {this.props.TotVol}
                                </p>
                            </div>
                            ...
                            <div className="card-body">
                                <h6 className="card-title" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#6C757D' }}> Circulating Supply</h6>
                                <p className="card-text fw-bold" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#212529', fontSize: 'small' }}>
                            ...
                            <div className="card-body">
                                <h6 className="card-title" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#6C757D' }}> Twitter Followers</h6>
                                <p className="card-text fw-bold" style={{ fontFamily: 'NHaasGroteskDSPro-65Md', color: '#212529', fontSize: 'small' }}>
                                    {this.props.twitterF}
                                </p>
                            </div>
